...
{
    private static readonly Func<NorthwindContext, int, User?> _getUserByID =
           EF.CompileQuery(
               (NorthwindContext dbContext, int id) =>
               dbContext.Users.FirstOrDefault(_ => _.Id == id));

    public User? GetUserByID(int id) => _getUserByID(this, id);
    ...
    public virtual DbSet<VwCustomerProduct> VwCustomerProducts { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=.;Database=Northwind; User ID=sa; Password=YourPassword...;encrypt=false");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Action>(entity =>
        {
            ...
            entity.HasOne(d => d.IdModuleNavigation).WithMany(p => p.Actions)
        ...
        modelBuilder.Entity<UserAction>(entity =>
        {
            ...
            entity.HasOne(d => d.IdModuleNavigation).WithMany(p => p.UserActions)
                .HasForeignKey(d => d.IdModule)
                .HasConstraintName("FK_UserAction_Modules");

            entity.HasOne(d => d.IdUserNavigation).WithMany(p => p.UserActions)
                .HasForeignKey(d => d.IdUser)
                .HasConstraintName("FK_UserAction_Users");
        });
        ...
        modelBuilder.Entity<VwCustomerProduct>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VwCustomerProducts");
